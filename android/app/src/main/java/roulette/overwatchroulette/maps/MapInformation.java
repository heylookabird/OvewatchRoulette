...
public class MapInformation {
    ...
    public static void init(Context context){
        ...
        drawables.put("Hanamura_Both", R.drawable.hanamura);
        ...
        drawables.put("Gibraltar_Both", R.drawable.gibraltar);
